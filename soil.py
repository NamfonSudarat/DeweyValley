...
class Plant(pygame.sprite.Sprite):
    def __init__(self, plant_type, groups, soil, check_watered):
        ...
        self.frames = import_folder(f's2 - basic player/graphics/fruit/{plant_type}')
        self.soil = soil
...
class SoilLayer:
    def __init__(self, all_sprites, collision_sprites):
        ...
        self.soil_tf = import_folder_dict('s2 - basic player\graphics\soil')
        self.water_surf = import_folder('s2 - basic player\graphics\soil_water')
        
        self.create_soil_grid()
        self.create_hit_rects()
        #  sound
        self.hoe_sound = pygame.mixer.Sound('s2 - basic player/audio/hoe.wav')
        self.plant_sound = pygame.mixer.Sound('s2 - basic player/audio/plant.wav')

    def create_soil_grid(self):
        ground = pygame.image.load('s2 - basic player\graphics\world\ground.png')
        h_tiles, v_tiles = ground.get_width() // TILE_SIZE, ground.get_height() // TILE_SIZE
        
        self.grid = [[[] for col in range(h_tiles)] for row in range(v_tiles)]
        for x, y ,_ in load_pygame('s2 - basic player\data\map.tmx').get_layer_by_name('Farmable').tiles():
